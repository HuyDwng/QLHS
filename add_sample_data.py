...
def add_sample_data():
    with app.app_context():
        ...
        # Thêm lớp học
        class_rule = ClassRule(maxNumber=40)
        db.session.add(class_rule)

        class1 = Class( grade='Khối 10', class_name='Lớp 10A', classRule=class_rule)
        class2 = Class(grade='Khối 11', class_name='Lớp 11A', classRule=class_rule)
        class3 = Class( grade='Khối 12', class_name='Lớp 12A', classRule=class_rule)
        ...
        for student in students:
            for subject in subjects:
                ...
                random_semester = random.choice([1, 2])
