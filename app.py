...
from QLHS.models import userLogin, Study
from QLHS import create_app, db
from flask import render_template, Flask, jsonify, request, flash, redirect, url_for, session
from QLHS.models import userLogin, Subject, Year, Semester, Class, Point, Student, StudentRule, ClassRule, Teacher, \
    Teach, PointType
from werkzeug.security import generate_password_hash
from flask import render_template, redirect, url_for, flash
from datetime import datetime, date
from QLHS.models import Student, StudentRule, PhoneNumber, Email, db
